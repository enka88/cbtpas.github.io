	...
	<div class="row h-100 justify-content-center align-items-center">
		<div class="card">
			...
			<div class="card-body">
                ...
                <form data-toggle="validator" role="form" method="post" action="<?php echo base_url('login/proses'); ?>">                                
					<div class="row">	
						<div class="col-md-12">    
							...
							<label>Authentication ID</label>
								<div class="input-group">
									...
									<input class="form-control" name="idserver" value="" placeholder="Authentication ID">								  
								</div>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input class="form-control" name="idsekolah" value="<?php echo profile()['sekolah'];?>">
								</div>	
								<div class="help-block with-errors text-danger"></div>
							</div>
						</div>
